...
firstw=Tk()
firstw.title("LOVELY PROFESSION UNIVERSITY")
firstw.geometry("1600x1000+0+0")
label=Label(text="LOVELY PROFESSIONAL UNIVERSITY",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="LOVELY PROFESSIONAL UNIVERSITY", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
